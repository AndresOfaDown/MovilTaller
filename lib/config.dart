...
// ⚠️  MODO LOCAL — apunta al backend en http://192.168.100.167:8000
...
//   flutter run --dart-define=API_URL=http://192.168.100.167:8000/api/v1/
...
// - Physical device: use host machine LAN IP, e.g. http://192.168.100.167:8000/api/v1/
